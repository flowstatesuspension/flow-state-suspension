                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {unit.brand === 'Fox' && (<>
                        ...
                        <a href="/fox-fork-oil-volumes.html" target="_blank" rel="noopener noreferrer"
                          className="w-5 h-5 rounded overflow-hidden shrink-0" title="Fox Oil Volumes">
                          <img src="/oil.jpg" alt="Oil" className="w-full h-full object-cover" />
                        </a>
                        <a href="/fox-ifp-table.html" target="_blank" rel="noopener noreferrer"
                          className="w-5 h-5 rounded overflow-hidden shrink-0" title="Fox IFP Table">
                          <img src="/piston.jpg" alt="IFP" className="w-full h-full object-cover" />
                        </a>
                      </>)}
                      {unit.brand === 'Rockshox' && (<>
                        ...
                        <a href="/rockshox-fork-oil-volumes.html" target="_blank" rel="noopener noreferrer"
                          className="w-5 h-5 rounded overflow-hidden shrink-0" title="Rockshox Oil Volumes">
                          <img src="/oil.jpg" alt="Oil" className="w-full h-full object-cover" />
                        </a>
                        <a href="/rockshox-ifp-table.html" target="_blank" rel="noopener noreferrer"
                          className="w-5 h-5 rounded overflow-hidden shrink-0" title="Rockshox IFP Table">
                          <img src="/piston.jpg" alt="IFP" className="w-full h-full object-cover" />
                        </a>
                      </>)}
                    </div>
